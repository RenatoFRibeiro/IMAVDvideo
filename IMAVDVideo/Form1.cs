...
namespace IMAVDVideo
{
    ...
    {
        //Declare variables to use in all project
        ...
        {
            InitializeComponent();
            //HaarCascade id for face detection
            ...
            {
                MessageBox.Show("Rosto não reconhecido");
            }
        }
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show(textName.Text + " registado na Database com sucesso!");
        }
